...
import "../assets/pessoas.css"; // 🎨 CSS exclusivo da página
  ...
  return (
    <Layout>
      <div className="pessoas-page">
        {/* Header */}
        <div className="pessoas-header d-flex justify-content-between align-items-center mb-3">
        ...
        {/* Lista */}
        <div className="card shadow-sm mb-4 pessoas-card">
          <div className="card-header">Lista de Pessoas</div>
          <div className="card-body">
            <table className="table pessoas-table table-hover table-bordered">
              <thead>
                <tr>
                  <th>Nome</th>
                  <th>Email</th>
            ...
            <div className="modal-dialog modal-lg">
              <div className="modal-content">
                <div className="modal-header bg-success text-white">
                  <h5 className="modal-title">Cadastrar Pessoa</h5>
                </div>
                  ...
                  <div className="modal-body">
                    ...
                    <div className="form-group">
                      ...
                      <input
                        ...
                        value={formEdit.cpf}
                        onChange={(e) =>
                          setFormEdit({ ...formEdit, cpf: e.target.value })
                        }
                      />
                    </div>
                    <div className="form-group">
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          setFormEdit({ ...formEdit, senha: e.target.value })
                        }
                      />
                    </div>
                    <div className="form-group">
